...
class cherry(QMainWindow):
    def __init__(self):
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>樱桃的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/cherry.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 6:
            self.textEdit2.setText("樱桃健康")
        elif final_label == 7:
            self.textEdit2.setText("樱桃白粉病一般")
        elif final_label == 8:
            self.textEdit2.setText("樱桃白粉病严重")
        else:
