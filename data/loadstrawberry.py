...
class strawberry(QMainWindow):
    def __init__(self):
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>草莓的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/strawberry.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 38:
            self.textEdit2.setText("草莓健康")
        elif final_label == 39:
            self.textEdit2.setText("草莓叶枯病一般")
        elif final_label == 40:
            self.textEdit2.setText("草莓叶枯病严重")
        else:
