...
class citrus(QMainWindow):
    def __init__(self):
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>柑桔的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/citrus.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 24:
            self.textEdit2.setText("柑桔健康")
        elif final_label == 25:
            self.textEdit2.setText("柑桔黄龙病一般")
        elif final_label == 26:
            self.textEdit2.setText("柑桔黄龙病严重")
        else:
