...
class grape(QMainWindow):
    def __init__(self):
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>葡萄的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/grape.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 17:
            self.textEdit2.setText("葡萄健康")
        elif final_label == 18:
            self.textEdit2.setText("葡萄黑腐病一般")
        elif final_label == 19:
            self.textEdit2.setText("葡萄黑腐病严重")
        elif final_label == 20:
            self.textEdit2.setText("葡萄轮斑病一般")
        elif final_label == 21:
            self.textEdit2.setText("葡萄轮斑病严重")
        elif final_label == 22:
            self.textEdit2.setText("葡萄褐斑病一般")
        elif final_label == 23:
            self.textEdit2.setText("葡萄褐斑病严重")
        else:
