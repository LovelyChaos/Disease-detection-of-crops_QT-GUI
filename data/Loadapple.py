...
class apple(QMainWindow):
    def __init__(self):
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>苹果的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/apple.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 0:
            self.textEdit2.setText("苹果健康")
        elif final_label == 1:
            self.textEdit2.setText("苹果黑星病一般")
        elif final_label == 2:
            self.textEdit2.setText("苹果黑星病严重")
        elif final_label == 3:
            self.textEdit2.setText("苹果灰斑病")
        elif final_label == 4:
            self.textEdit2.setText("苹果雪松锈病一般")
        elif final_label == 5:
            self.textEdit2.setText("苹果雪松锈病严重")
        else:
