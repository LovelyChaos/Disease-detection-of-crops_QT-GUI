...
class potato(QMainWindow):
    def __init__(self):
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>马铃薯的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/potato.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 33:
            self.textEdit2.setText("马铃薯健康")
        elif final_label == 34:
            self.textEdit2.setText("马铃薯早疫病一般")
        elif final_label == 35:
            self.textEdit2.setText("马铃薯早疫病严重")
        elif final_label == 36:
            self.textEdit2.setText("马铃薯晚疫病一般")
        elif final_label == 37:
            self.textEdit2.setText("马铃薯晚疫病严重")
        else:
