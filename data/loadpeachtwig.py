...
class peachtwig(QMainWindow):
    def __init__(self):
        super(peachtwig, self).__init__()
        ##显示图片#######
        self.resize(600, 400)
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>桃的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/peachtwig.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 27:
            self.textEdit2.setText("桃健康")
        elif final_label == 28:
            self.textEdit2.setText("桃疮痂病一般")
        elif final_label == 29:
            self.textEdit2.setText("桃疮痂病严重")
        else:
