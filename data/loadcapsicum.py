...
class capsicum(QMainWindow):
    def __init__(self):
        super(capsicum, self).__init__()
        ##显示图片#######
        self.resize(600, 400)
        ...
        self.label2.setText("请从您的电脑上打开一张<br/>辣椒的叶片图像")
    ...
    def paintEvent(self, event):
        ...
        pixmap = QPixmap("image/capsicum.jpg")
    ...
    def openimage(self):
        ...
        if final_label == 30:
            self.textEdit2.setText("辣椒健康")
        elif final_label == 31:
            self.textEdit2.setText("辣椒疮痂病一般")
        elif final_label == 32:
            self.textEdit2.setText("辣椒疮痂病严重")
        else:
